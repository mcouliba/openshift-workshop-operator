...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkspacesSpec) DeepCopyInto(out *WorkspacesSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkspacesSpec.
func (in *WorkspacesSpec) DeepCopy() *WorkspacesSpec {
	if in == nil {
		return nil
	}
	out := new(WorkspacesSpec)
	in.DeepCopyInto(out)
	return out
}
